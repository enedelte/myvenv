...
from test_readmailfromdocx import extract_emails_from_docx, main
...
btn_recuperar_email = tk.Button(ventana, text="Imprimir mis correos", command=main, width=50, bg="#00526c", fg="white", relief="flat")
btn_recuperar_email.pack(pady=1)
