...
ventana = tk.Tk()
icono = r"C:\Users\dapache\python_scripts\myvenv\scripts_python\RPA_Correos\test\icono.ico"
version = "V.1.0.1"
imagen_path = "imagen.png"  #Imagen NEPS
...
btn_seleccionar_word = tk.Button(ventana, text='Imprimir mis pdf', command=None, width=10, bg="#00526c", fg="white", relief="flat")
btn_seleccionar_word.pack(pady=1, padx=1, side=None, fill="both")
# Botón para seleccionar el archivo CSV
btn_seleccionar_csv = tk.Button(ventana, text="Enviar mis correos", command=None, width=10, bg="#00526c", fg="white", relief="flat")
btn_seleccionar_csv.pack(pady=1, padx=1, side=None, fill="both")
...
etiqueta.pack(padx=1, pady=2, side="right", fill="both")
