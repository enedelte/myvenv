...
from masivos import cargue_masivos
...
ventana.geometry("900x900-100-50")  # Configurar el tamaño ventana
...
btn_convertir_pdf = tk.Button(ventana, text="Convertir PDF", command=seleccionar_rutas, width=10, bg="#00526c", fg="white", relief="flat")
btn_convertir_pdf.pack(pady=1, padx=20, side=None, fill="both")

# Botón envio correos
btn_enviar_email = tk.Button(ventana, text="Enviar Correos", command=main_func, width=10, bg="#00526c", fg="white", relief="flat")
btn_enviar_email.pack(pady=1, padx=20, side=None, fill="both")

# Bóton guardar enviados
btn_guardar_email = tk.Button(ventana, text="Guardar Correos Enviados", command=main, width=10, bg="#00526c", fg="white", relief="flat")
btn_guardar_email.pack(pady=1, padx=20, side=None, fill="both")

# Bóton sustraer datos txt
btn_cargue_masivos = tk.Button(ventana, text="Ingresar Datos", command=cargue_masivos, width=10, bg="#00526c", fg="white", relief="flat")
btn_cargue_masivos.pack(pady=1, padx=20, side=None, fill="both")
...
# etiqueta versión
etiqueta = tk.Label(ventana, text="Beta 1.0.8", width=50, border=10, bg="#002633", fg="white", relief="flat", justify="center")
