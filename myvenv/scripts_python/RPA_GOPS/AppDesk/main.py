...
import pandas as pd
import sys 
from funciones import enviar_correo_desde_alias, enviar_correos_desde_csv, seleccionar_archivo_csv, main
...
boton_seleccionar_docx()
# Botón para seleccionar el archivo CSV

def boton_seleccionar_csv():
